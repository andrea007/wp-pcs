	...
	<div class="body-inner">
		<div class="container">
			...
			<div class="header clearfix header-logo-type-<?php echo esc_attr($logo_arr['logo_type']) ?>">
              ...
              ?>
                <?php if($location) { ?>
                  <div class="header-location header-under-logo"><?php echo esc_html($location); ?></div>
                <?php } ?>
						</div>
					</div>
					<?php } ?>
					<div class="header-info">
						...
						<div class="header-info-top">
							...
							<?php } ?>
							<div class="header_supporters">
								<img src="/wp-content/uploads/2017/04/nhs_digital_socitm_supported-1.png" alt="Our Sponsors">
							</div>
