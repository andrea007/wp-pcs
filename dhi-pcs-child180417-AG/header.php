			...
			<div class="header clearfix header-logo-type-<?php echo esc_attr($logo_arr['logo_type']) ?>">
				<div class="header-top clearfix">
					...
					<div class="header-info">
						...
						<?php } ?>
						<!--- registration moved up to this position --->
				...
				<div class="header-menu clearfix <?php echo $class.(get_option('eventerra_menu_uppercase')=='true'?' apply-uppercase':'').(get_option('eventerra_menu_root_bold')=='true'?' root-items-bold':'') ?>">
					...
					<div class="sponsors-home">
					  	<span class="main-sponsor-text">Supported by: </span>
						<img src="https://publiccybersecurity.com/wp-content/uploads/2017/05/nhs_digital_and_socitm_small.png" usemap="#sponsormap">
<map name="sponsormap" id="sponsormap">
    <area alt="" title="" href="https://www.socitm.net/" shape="poly" coords="7,3,8,32,80,34,80,5,81,2" target="_blank" />
    <area alt="" title="" href="https://digital.nhs.uk/" shape="poly" coords="90,3,91,35,141,37,143,3" target="_blank" />
    [...]
</map>
					     </div>
<div class="main-sponsor">
					    <span class="main-sponsor-text">Main sponsor</span>
					  	<a href="http://www.cisco.com/" target="_blank"><img src="https://publiccybersecurity.com/wp-content/uploads/2017/04/cisco-e1493295056676.png" alt="Cisco - Main sponsor of Public Cyber Security"></a>
					  </div>
