...
function eventerra_get_icons_list() {
...
function eventerra_get_icons_options_list($selected='') {
	
	$arr=eventerra_get_icons_list();
	$out='<option value="">'.esc_html__('No icon','eventerra').'</option>';
	foreach($arr as $id=>$v) {
...
function eventerra_get_icons_preview_list() {
	...
	foreach($arr as $id=>$v) {
		...
		foreach($v['icons'] as $icon) {
			$value=$v['prefix'].$icon;
			$out.='<div class="om-item" title="'.esc_attr($icon).'" data-icon="'.$value.'"><i class="'.eventerra_icon_classes($value).'"></i></div>';
		}
	}
...
function eventerra_icon_classes($icon) {
...
function eventerra_icon_classes_before($icon) {
