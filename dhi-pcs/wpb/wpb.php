...
define('EVENTERRA_TEMPLATE_WPB_DIR', EVENTERRA_TEMPLATE_DIR . '/wpb'); // without the trailing slash
define('EVENTERRA_TEMPLATE_WPB_DIR_URI', EVENTERRA_TEMPLATE_DIR_URI . '/wpb' ); // without trailing slash
