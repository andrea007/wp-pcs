...
$om_css_class[]=$this->getCSSAnimation( $css_animation );
$om_wrapper_attributes[]=eventerra_wpb_get_animation_delay($atts);
...
$vc_row_html .=
	'<div class="'.$om_css_class.'"'.$style.$om_wrapper_attributes.'>'.$video_html.$parallax_html.$dimming_html.
