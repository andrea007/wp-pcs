...
$output = '<div ' . implode( ' ', $wrapper_attributes ) . ' class= "'.$css_class.'" data-pie-value="'.$value.'" data-pie-animate-label="'.$animate_label.'" data-pie-label-value="'.$label_value.'" data-pie-units="'.$units.'" data-pie-color="'.esc_attr($color).'"'.($width?' style="max-width:'.$width.'"':'').'>';
